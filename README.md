...
[`docs/BUILD-PLAN.md`](docs/BUILD-PLAN.md) maps the work across all three
repositories: what blocks what, what can be built in parallel, and a
plain-language description of every piece.
